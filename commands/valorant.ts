import { Embed, InteractionResponseType, SlashCommandInteraction } from 'https://deno.land/x/harmony@v2.6.0/mod.ts'
...
export const sendValorantFixtureEmbed = async (interaction: SlashCommandInteraction) => {
    if (!interaction.data) {
        return;
    }
