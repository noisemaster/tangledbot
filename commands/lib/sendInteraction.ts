import { Interaction, Message, TextChannel, User } from "https://deno.land/x/harmony@v2.0.0-rc1/mod.ts";
import { WebhookMessageOptions } from "https://deno.land/x/harmony@v2.0.0-rc1/src/structures/webhook.ts";
