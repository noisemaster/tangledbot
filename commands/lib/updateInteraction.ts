import { Bot, DiscordMessage, InteractionResponseTypes, Message, InteractionCallbackData, BotInteractionCallbackData, CamelizedDiscordMessage, Interaction } from "@discordeno/bot";
