...
import { MessageReaction } from "https://deno.land/x/harmony@v1.0.0/src/structures/messageReaction.ts";
import { User } from "https://deno.land/x/harmony@v1.0.0/src/structures/user.ts";
